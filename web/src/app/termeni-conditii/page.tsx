...
const sections = [
  {
    ...
    content: `Prezentul site, accesibil la adresa scudiver.ro, este operat de SCUDIVER 2016 SRL, persoană juridică română, cu sediul social la Str. Unirii bl 5A/17, Sighetu Marmatiei, Maramures, înregistrată la Registrul Comerțului sub nr. J24/541/2016, CUI RO35975938, email: office@scudiver.ro, tel: 0753 657 215 (denumită în continuare „ScuDiver" sau „Operatorul").`,
  },
  {
    id: "obiect",
...
• Orice acțiune care ar putea afecta funcționarea, securitatea sau integritatea Site-ului.`,
  },
  {
    ...
    content: `Toate elementele de conținut ale Site-ului — texte, grafică, logo-uri, imagini, structura paginilor — sunt proprietatea exclusivă a SCUDIVER 2016 SRL sau sunt utilizate cu acordul deținătorilor de drepturi, și sunt protejate prin legislația română și europeană privind drepturile de proprietate intelectuală.
...
Orice litigiu decurgând din sau în legătură cu prezentele Termeni și Condiții va fi soluționat de instanțele judecătorești competente din Sighetu Marmatiei, România, sau prin procedura de soluționare alternativă a litigiilor (SAL) disponibilă la ANPC.`,
  },
  {
    id: "contact",
    title: "9. Contact",
...
Telefon: 0753 657 215
Adresă: Str. Unirii bl 5A/17, Sighetu Marmatiei, Maramures
